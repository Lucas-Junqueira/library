class Book:
    ...
    def get_charge(self, days_rented: int) -> float:
        """Calcula o valor do aluguel para este livro, dado o número de dias alugados."""
        amount = 0
    ...
    def get_frequent_renter_points(self, days_rented: int) -> int:
        """Calcula os pontos de fidelidade para este livro dado o número de dias alugados."""
        points = 1
...
class Rental:
    ...
    def get_charge(self) -> float:
        """Delegates the charge calculation to the Book."""
        return self.book.get_charge(self.days_rented)

    def get_frequent_renter_points(self) -> int:
        """Delegates the frequent renter points calculation to the Book."""
